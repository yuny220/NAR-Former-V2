...
def extract_topology_feature(nx_G, name2id, id2name, embed_type, input_type='np_array'):
...
def extract_static_feature(static_info, embed_type, input_type='np_array'):
...
def extract_depthtoken_feature(depth, embed_type, input_type='np_array'):
...
def extract_end_feature(end, embed_type, input_type='np_array'):
    embeddings = []
