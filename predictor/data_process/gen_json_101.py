...
# executing.
NASBENCH_TFRECORD = '/home/disk/dataset/NasBench101/nasbench_only108.tfrecord'
...
def gen_data_point(nasbench):
    ...
    for unique_hash in nasbench.hash_iterator():
        ...
        model_spec = ModelSpec(fixed_metrics['module_adjacency'], fixed_metrics['module_operations'])
        ...
        if len(ops)<min_l:
            min_l = len(ops)
        print('best val. acc: {:.4f}, best test acc {:.4f}, min length of nodes {:d}'.format(best_val_acc, best_test_acc, min_l))
...
def gen_json_file():
    ...
    with open('/home/disk/dataset/NasBench101/nasbench101.json', 'w') as outfile:
